# -*- coding: utf-8 -*-
#------------------------------------------------------------
# http://www.youtube.com/user/omeleteve
#------------------------------------------------------------
...
addonID = 'plugin.video.OmeleteTv'
...
def main_list(params):
	plugintools.log("OmeleteTv_list "+repr(params))
	
	plugintools.log("OmeleteTV.run")
