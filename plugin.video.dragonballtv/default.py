...
AddonID = 'plugin.video.dragonballtv'
...
addon_data_dir = os.path.join(xbmc.translatePath("special://home/addons/plugin.video.dragonballtv/data" ).decode("utf-8"), AddonID)
