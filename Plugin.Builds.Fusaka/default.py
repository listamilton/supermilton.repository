...
ADDON=xbmcaddon.Addon(id='plugin.video.Fusaka')
...
def CATEGORIES():
    link = OPEN_URL('http://builds.fusaka.com.br/Wizard/Wizard.html').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("[COLOR=aqua]Fusaka Kodi Wizard[/COLOR]","[COLOR=red]BAIXANDO[/COLOR]",'', '[COLOR=orange]Aguarde por Favor...[/COLOR]')
